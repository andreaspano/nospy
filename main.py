...
def main():
    ...
    parser.add_argument("--cpu",action="store_true",help="Force CPU-only execution (disables GPU).")
    
    parser.add_argument("--gpu",type=str,default=None,help="Comma-separated list of GPU device IDs to use (e.g., '0' or '0,1').")
